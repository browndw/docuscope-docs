...
<details> 
<summary>You can copy the citation in **APA** format:</summary>
```{.json .code-overflow-wrap}
Kaufer, D. & Ishizaki, S. (2023). The DocuScope project: History, theory and future directions. In D. W. Brown & D. Zawodny Wetzel (Ed.), Corpora and Rhetorically Informed Text Analysis: The diverse applications of DocuScope (pp. 2-24). John Benjamins Publishing Company. https://doi.org/10.1075/scl.109.01kau
```
</details> 

<details> 
<summary>Or in **BibTex** format:</summary>
```{.json .code-overflow-wrap}
...
## I. The Problem: Bridging Thought and Language

### Traditional Challenge
- Classical rhetoric separated **invention** (what to say) from **style** (how to say it)
- Question remained: *How do thoughts become concrete language?*

### DocuScope's Solution
- Identify **rhetorical language patterns** that unify invention and style
- Study how specific word sequences create rhetorical effects

---

## II. The Hidden Middle Layer: Composing Patterns

### Key Insight
Between grammar and genre exists a crucial layer: **composing patterns**—reusable word sequences that create specific rhetorical effects.

### Examples
- "I often used to..." → signals autobiographical narrative
- "no surprise that..." → expresses confident prediction
- "let freedom ring" → combines positive values with descriptive imagery

### Impact
These patterns shape how readers experience text:
- **Tone** (subjective vs. objective)
- **Purpose** (descriptive, persuasive, facilitative)
- **Register** (academic, personal, public)

---

## III. DocuScope: The Tool and Dictionary

### What It Does
- Software that automatically identifies rhetorical patterns in texts
- Dictionary contains millions of 3-5 word sequences classified by rhetorical function
- Provides interactive visualization of rhetorical choices

### Building Process
- **Human-curated**: Scholars manually classify patterns based on rhetorical function
- **Corpus-driven**: Patterns drawn from real texts across many genres
- **Continuously updated**: Dictionary grows through ongoing research

---

## IV. Three Key Dimensions of Rhetoric

DocuScope organizes language patterns along three continua:

| **Interiority ↔ Externality** | Inner thoughts and feelings vs. public, external world |
|-------------------------------|-------------------------------------------------------|
| **Stories ↔ Information** | Narrative sequence vs. hierarchical explanation |
| **Monologic ↔ Dialogic** | Speaker-focused vs. audience-aware language |

### Sample Categories
- **Academic** – Specialized, formal discourse  
- **Narrative** – Time-based storytelling
- **Confidence** – Expressing certainty or uncertainty
- **Description** – Sensory and visual language
- **First Person** – Subjective, personal perspective
- **Positive/Negative** – Emotional tone and affect

---

## V. Key Challenge: Polysemy (Multiple Meanings)

Small changes in word patterns can dramatically shift meaning:

- **"swearing at"** vs. **"swearing to"** (different actions entirely)
- **"they know what they're doing"** (confidence) vs. **"they doubt they know what they're doing"** (uncertainty)
- **Length matters**: Longer patterns often override shorter ones for more precise classification

---

## VI. Applications: From Research to Education

### Research Uses
- Analyze large text collections (corpora)
- Study literary works and historical documents
- Support policy analysis and genre studies

### Educational Applications
- **DocuScope Write & Audit**: Helps students analyze their own writing
- Provides feedback on rhetorical choices
- Shows how language patterns create reader experiences
...
### Core Innovation
DocuScope reveals the **hidden rhetorical choices** writers make, providing a practical bridge between thought and expression.

### Educational Value
Students can see how their language choices shape reader experience, making revision more strategic and effective.

### Ongoing Development
The project continues evolving as a shared resource for understanding how language creates rhetorical impact across different genres and contexts.

---

*DocuScope makes visible the invisible: how writers use language patterns to guide reader experience and achieve rhetorical goals.*
