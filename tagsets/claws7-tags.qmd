# Part-of-Speech Tags {.unnumbered}

{{< iconify material-symbols:construction >}} Under construction.

::: {.callout-important}
## DocuScope CA runs on a model
All models are trained on the [CLAWS7 tagset](https://ucrel.lancs.ac.uk/claws7tags.html){target="_blank"}. While the original tagger is [a rules-based system](http://www.natcorp.ox.ac.uk/docs/claws7.html){target="_blank"}, [the model](https://huggingface.co/browndw/en_docusco_spacy) is trained on data with those tags. In other words, it uses the **tagset** but **not the tagger**.
:::


<details> 
<summary>Cite the tagset in **APA** format:</summary>
...
```{.json .code-overflow-wrap}
@incollection{garside1997higher,
  ...
  editor={Garside, Roger, Leech, Geoffrey, McEnery, Anthony},
  pages={102--121},
  year={1997},
  publisher={Longman}
}
