...
::: {.callout-tip}
Connect category use to **audience expectations**, **genre conventions**, or **communicative goals**.
:::
...
::: {.callout-tip}
Use simple bar charts or frequency tables. Label everything clearly and interpret the figure in your writing. Don't just say "Figure 1 shows the results"—explain what the reader should notice and why it matters.
:::
